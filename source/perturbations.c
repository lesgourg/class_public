    ...
    */
    ...
    if (ppt->gauge == newtonian) {
      ...
      */
      ...
      else if (pba->has_idm == _TRUE_) // ethos !!!DCH why isn't this an if?
    ...
    if (pba->has_idm == _TRUE_){ // where does this come from? why do we treat our DM as ultrarelativistic? !!!DCH
