...
struct perturbations
{
  ...
  double tau_ini_gwb; /**< the inital time for the graviational wave background. This will then also fix the initial sampling time of the sources. */
  ...
  int index_tp_gwb_sw; /**< index value for gravitational wave background (j=1 term) */ //TODO_GWB: This is only a dirty fix to get the phi
