...
struct background
{
  ...
  double f_dec_ini;  /**< fraction of decoupled relativistic particles at time of GWB generation */
  double f_dec_late; /**< fraction of decoupled relativistic particles at start of CLASS computation of the ISW */
