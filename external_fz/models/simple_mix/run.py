...
##### In this block the external parameters in sys.argv[1:] are read and translated into the parameters you like
## In the given example case study the parameters are the DM mass at which the spectra should be sampled
## and the relative contribbution of muons to the total spectrum.
