    ...
    def calc_f(self, transfer_instance):
        if not isinstance(transfer_instance, transfer):
            ...
            if self.injection_hist == 'annihilation':
                f_func = misc.f_function_annihilation(transfer_instance.log10E, transfer_instance.z_injected, 
                 ...
                 f_func = misc.f_function_decay(transfer_instance.log10E, transfer_instance.z_injected, 
